...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--save_path', type=str, default='weights/Hatt-2/', help='save path')
        self.parser.add_argument('--model_name', type=str, default='Hatt', help='training or testing model name')
