...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--save_path', type=str, default='weights/WDR-4/', help='save path')
        ...
        self.parser.add_argument('--field_cnt', type=int, default=13, help='the number of filed for trajectory features')
        self.parser.add_argument('--feature_tra', type=int, default=1385, help='number of the trajectory feature elements')
        ...
        self.parser.add_argument('--file_train_t', type=str, default='/Users/guojianzou/Travel-time-prediction/data/trajectory_3.csv', help='trajectory file address')
