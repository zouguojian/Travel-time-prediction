...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--save_path', type=str, default='weights/Deep/', help='save path')
        self.parser.add_argument('--model_name', type=str, default='Deep', help='training or testing model name')
