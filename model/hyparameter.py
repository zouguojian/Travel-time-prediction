...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--save_path', type=str, default='weights/MT-STAN-2/', help='save path')
        ...
        self.parser.add_argument('--feature_tra', type=int, default=32274, help='number of the trajectory feature elements')
