...
class parameter(object):
    def __init__(self,parser):
        ...
        # data-1 > 1360
        # data-1 > 10259
        self.parser.add_argument('--save_path', type=str, default='weights/CompactETA-3/', help='save path')
        self.parser.add_argument('--field_cnt', type=int, default=12, help='the number of filed for trajectory features')
        self.parser.add_argument('--feature_tra', type=int, default=1360, help='number of the trajectory feature elements')
        self.parser.add_argument('--trajectory_length', type=int, default=3, help='length of trajectory')
        self.parser.add_argument('--file_train_t', type=str, default='/home/ibdi_public/traffic/Travel-time-prediction/data/trajectory_3.csv', help='trajectory file address')
        ...
        self.parser.add_argument('--file_train_s', type=str, default='/home/ibdi_public/traffic/Travel-time-prediction/data/train.csv', help='training_speed file address')
