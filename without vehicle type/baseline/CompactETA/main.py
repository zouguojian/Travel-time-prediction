...
from model.eta_inf import CompactETAClass
from model.data_next import DataClass
from model.utils import construct_feed_dict, one_hot_concatenation, metric, FC
...
class Model(object):
    ...
    def evaluate(self):
        ...
        mae_tra_sum, rmse_tra_sum, mape_tra_sum = metric(pred=pre_tra_sum_list, label=label_tra_sum_list)  # 产生预测指标
