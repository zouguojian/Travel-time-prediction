...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--save_path', type=str, default='weights/MDL/', help='save path')
        self.parser.add_argument('--model_name', type=str, default='MDL', help='training or testing model name')
