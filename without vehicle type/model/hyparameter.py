...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--model_name', type=str, default='MT-STAN', help='training or testing model name')
        ...
        # data-1 > 1360
        # data-1 > 10259
        self.parser.add_argument('--save_path', type=str, default='weights/MT-STAN-4/', help='save path')
        self.parser.add_argument('--field_cnt', type=int, default=16, help='the number of filed for trajectory features')
        self.parser.add_argument('--feature_tra', type=int, default=10259, help='number of the trajectory feature elements')
        self.parser.add_argument('--file_train_t', type=str, default='data/trajectory_4.csv', help='trajectory file address')
